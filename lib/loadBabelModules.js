;(function loadModules() {
	...
	function appendScript(src, dataset) {
		...
		if (dataset.presets) appendedScript.setAttribute('data-presets', dataset.presets)
		if (dataset.plugins) appendedScript.setAttribute('data-plugins', dataset.plugins)
	}
	...
	function relativeToAbs(abs, relative) {
		...
		if (abs.charAt(abs.length - 1) === '.') abs = abs.substring(0, abs.length - 1)
